...
knitr::opts_chunk$set(message=TRUE,warning=FALSE, cache=TRUE)
```
...
print("Hello Python!")
import pandas
critters = pandas.read_csv("csv/dailyCalories_merged.csv")
critters.head(n=3)
print(critters)
import os
